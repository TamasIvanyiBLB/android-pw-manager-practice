...
import com.example.androidpracticeapp_passwordmanager.viewmodels.CreateAccountUIStateVM
...
fun CreateLogin(navController: NavController, vm: CreateLoginViewModel = hiltViewModel()) {
    Column(modifier = Modifier.fillMaxSize(), verticalArrangement = Arrangement.Center) {
        ...
        OutlinedTextField(
            value = getInputBoxValueBinding(vm.createAccountUIState),
            onValueChange = { },
            label = {
                Text(
                    "label",
...
fun getInputBoxValueBinding(createAccountUIState: State<CreateAccountUIStateVM>): String {
    return if(createAccountUIState.value.password == null){
        createAccountUIState.value.login?:""
    }
    else if(createAccountUIState.value.passwordRepeat == null){
        createAccountUIState.value.password?:""
    }
    else{
        createAccountUIState.value.passwordRepeat?:""
    }
}
